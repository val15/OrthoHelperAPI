...
{
    public class OrthoEngineCorrectorRunTests
    {
        ...
        public OrthoEngineCorrectorRunTests(ITestOutputHelper output)
        {
        ...
        public void OrthoService_Initialization_Success()
        {
            ...
            var engine = new OrthoEngineCorrector(_client, _mockCorrectionSessionRepository.Object, _mockCurrentUserService.Object, _mockLogger.Object);
