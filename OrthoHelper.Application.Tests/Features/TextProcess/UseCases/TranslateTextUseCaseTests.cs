...
public class TranslateTextUseCaseTests
{
    ...
    private readonly Mock<ITranslatorOrchestrator> _mockCorrectionOrchestrator = new();

    private readonly TranslateTextUseCase _useCase;

    public TranslateTextUseCaseTests()
    {
        ...
        _useCase = new TranslateTextUseCase(_mockCorrectionOrchestrator.Object, 
